...
public:
    void visit(Square& square) override {
        int side = static_cast<int>(square.getM_side());
        std::cout << "Square with side " << square.getM_side() << ":\n";
    ...
    void visit(Rectangle& rectangle) override {
        int width = static_cast<int>(rectangle.getM_width());
        int height = static_cast<int>(rectangle.getM_height());
        std::cout << "Rectangle with width " << rectangle.getM_width() << " and height " << rectangle.getM_height() << ":\n";
